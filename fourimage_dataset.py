...
def get_df_stone(k_fold, data_dir, data_folder, out_dim = 1, out_dim2=0, use_meta = False, use_ext = False, side_task=0):
    ...
    df_train = pd.read_csv(os.path.join(data_dir, data_folder, 'train_4image.csv'))
    ...
    df_train['filepath'] = df_train['file_name'].apply(lambda x: os.path.join(data_dir, f'{data_folder}train_4image', x))  # f'{x}.jpg'
